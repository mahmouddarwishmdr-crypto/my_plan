...
const Map<String, String> _arabicTranslations = {
  ...
  'Settings': 'الإعدادات',
  'Back': 'رجوع',
  'Good morning, Alex 👋': 'صباح الخير، أليكس 👋',
  ...
  'Metric (kg, cm, kcal)': 'متري (كجم، سم، سعر حراري)',
  ...
  'Insights': 'الرؤى',
  'Remaining': 'المتبقي',
  "You're on track! 🎯": 'أنت على المسار الصحيح! 🎯',
  'Log water': 'تسجيل الماء',
  'You have': 'لديك',
  'kcal remaining': 'سعر حراري متبقٍ',
  'Logged': 'مسجل',
  'Planned': 'مخطط',
  'Skipped': 'متخطى',
  ...
  '* Percent Daily Values are based on a 2,000 calorie diet.':
      '* النسب اليومية مبنية على نظام غذائي يحتوي على 2000 سعر حراري.',
  '2,340 kcal more than last week': '2340 سعرا حراريا أكثر من الأسبوع الماضي',
  'Protein intake is improving': 'استهلاك البروتين يتحسن',
  'Goal hit 5 of 7 days': 'تحقق الهدف خلال 5 من 7 أيام',
  'of 1,800 kcal': 'من أصل 1800 سعرا حراريا',
  'remaining': 'متبقٍ',
  'Results for': 'نتائج',
  ...
  '420 kcal': '420 سعرا حراريا',
  '620 kcal': '620 سعرا حراريا',
  '200 kcal': '200 سعرا حراريا',
  '450 kcal': '450 سعرا حراريا',
